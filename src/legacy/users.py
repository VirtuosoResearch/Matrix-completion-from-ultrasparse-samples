...
if __name__ == "__main__":
    ...
    args.label = "users_" +  dataset_str + r_str + p_str
    ...
    for d1 in users_list:
        ...
        for run in range(args.runs):
            ...
            ob2_rmse_err = lstsq_recovery(estimation_goal=estimation_matrix, M=M, masks=masks, r=r, recovery_masks=recovery_masks, use_reg=True, lam=0.001)
