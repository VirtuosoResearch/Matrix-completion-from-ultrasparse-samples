...
if __name__ == "__main__":
    ...
    for epsilon in epsilon_list:
        ...
        for run in range(args.runs):
            ...
            mask_err_all = T*T_masks - MTM*T_masks
            ...
            svd_err = relative_err(direct_SVD, MTM)
            ...
            #X_T, err_estimates = soft_impute(T, T_masks, MTM, r, use_power_method=True, draw=False)
            X_T, err_estimates = alt_min(T, T_masks, MTM, r, draw=True)
