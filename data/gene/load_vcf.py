...
# 打开 VCF 文件
vcf_file = './ALL.chr22.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.vcf'
#vcf = cyvcf2.VCF('../ALL_GGVP.chr1.shapeit2_integrated_snvindels_v1b_20200120.GRCh38.phased.vcf')
vcf = cyvcf2.VCF('./ALL.chr22.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.vcf')
...
def vcf_to_npy(vcf_data, snp_pos_fmt=None, snp_ref_fmt=None, miss_fill=-1, return_idx=False, verbose=True):
    """
